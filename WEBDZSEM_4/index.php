<?php
$masNav = [
    ["name" => "Режиссер", "Date" => 'Январь 2015 '],
    ["name" => "Оператор", "Date" => 'Март 2016 '],
    ["name" => "Сценарист", "Date" => 'Август 2017 '],
    ["name" => "Гример", "Date" => 'Июнь 2018 '],
    ["name" => "Каскадер", "Date" => 'Декабрь 2014 '],
];
?>
        ...
        <div class="w3-row-padding">
            ...
            <div class="w3-twothird">
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <?php for ($i = 0; $i < count($masNav); $i++): ?>
                    <div class="w3-container">
                        <h5 class="w3-opacity"><b>
                                <p>
                                    <?php echo $masNav[$i]["name"]; ?>
                                </p>
                            </b></h5>
                        <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                            <?php echo $masNav[$i]["Date"]; ?><span class="w3-tag w3-teal w3-round">Текущая</span>
                        </h6>
